...
New: Added a new filter hook to modify the redirect URL after purchasing a course.
Fix: Resolved the issue that prevented instructors from deleting announcements and quiz attempts in the Admin panel.
